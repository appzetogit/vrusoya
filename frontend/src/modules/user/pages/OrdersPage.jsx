        ...
        <div className="bg-background min-h-screen py-4 md:py-12">
            <div className="container mx-auto px-3 md:px-12">
                <div className="flex items-center gap-2 md:gap-4 mb-6 md:mb-10">
                    <button onClick={() => navigate('/profile')} className="p-2 -ml-2 hover:bg-gray-100 rounded-lg transition-colors text-textPrimary/70">
                        <ArrowLeft size={20} md:size={24} />
                    </button>
                    <h1 className="text-xl md:text-3xl font-black text-textPrimary uppercase tracking-tighter md:tracking-tight">My Orders</h1>
                </div>
                                    ...
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <div className="flex items-center gap-3 rounded-xl border border-slate-100 bg-slate-50/70 p-2.5">
                                            ...
                                            <div className="min-w-0">
                                                ...
                                                <p className="text-sm md:text-base font-black text-textPrimary truncate">
                                        ...
                                        <div className="pt-1">
                                            <Link
                                                to={`/order/${orderId}`}
                                                className="w-full md:w-fit md:ml-auto md:px-10 bg-slate-50 border border-slate-100 text-textPrimary py-2.5 md:py-3 rounded-xl text-[9px] md:text-xs font-black uppercase tracking-widest active:scale-95 transition-all flex items-center justify-center gap-2 hover:bg-secondary hover:text-white"
                                            >
                                                View Details
                ...
                {totalPages > 1 && (
                    <div className="max-w-4xl mx-auto mt-6 md:mt-8 flex items-center justify-between gap-3">
                        <button
                            ...
                            className="px-4 py-2 rounded-lg border border-slate-200 bg-white text-xs md:text-sm font-bold text-textPrimary disabled:opacity-40 disabled:cursor-not-allowed hover:bg-slate-50 transition-colors"
                        >
                            Previous
                        </button>
                                ...
                                <button
                                    ...
                                    className={`w-8 h-8 md:w-9 md:h-9 rounded-lg text-xs md:text-sm font-black transition-colors ${
                                        currentPage === page
                                            ...
                                            : 'bg-white border border-slate-200 text-textPrimary hover:bg-slate-50'
                                    }`}
                                >
                                    {page}
                                </button>
