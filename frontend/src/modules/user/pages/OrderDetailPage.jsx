            ...
            <div className="container mx-auto px-3 md:px-12 max-w-4xl">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 md:mb-10">
                    <div className="flex items-center gap-2 md:gap-4">
                        ...
                        <div>
                            <h1 className="text-xl md:text-3xl font-black text-textPrimary uppercase tracking-tighter md:tracking-tight leading-none">Order Details</h1>
                                    ...
                                    {latestTrackingActivity && (
                                        <div className="flex gap-3 items-start">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="text-xs font-bold text-textPrimary">{latestTrackingActivity.activity}</p>
                            ...
                            <div className="space-y-4">
                                <div className="flex gap-3">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <p className="text-sm font-black text-textPrimary">{order.shippingAddress.fullName}</p>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs font-black text-textPrimary uppercase tracking-tighter">
