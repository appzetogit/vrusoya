        ...
        <div className="bg-background min-h-screen py-12">
            <div className="container mx-auto px-4 md:px-12 max-w-3xl">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h1 className="text-2xl font-black text-textPrimary uppercase tracking-tight">Request Return / Exchange</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                                    ...
                                    >
                                        ...
                                        <div className="flex-1">
                                            <div className="flex justify-between items-start">
                                                <p className="font-bold text-textPrimary text-sm leading-tight max-w-[200px]">{item.name}</p>
                                                {isAlreadyReturned && (
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm transition-all hover:shadow-md">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            >
                                ...
                                <p className="font-black text-textPrimary text-base uppercase tracking-tight">Refund</p>
                            ...
                            >
                                ...
                                <p className="font-black text-textPrimary text-base uppercase tracking-tight">Replacement</p>
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {variants.map(v => (
                                            ...
                                            >
                                                <div className={`text-sm font-black ${replacementVariantId === v.id ? 'text-primary' : 'text-textPrimary'}`}>{v.weight}</div>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <label className={`flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all ${replacementMethod === 'reverse' ? 'border-primary bg-primary/5' : 'border-gray-100 hover:border-gray-200'}`}>
                                            ...
                                            <div>
                                                <p className="text-sm font-bold text-textPrimary uppercase tracking-tight">Standard Exchange</p>
                                        ...
                                        <label className={`flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all ${replacementMethod === 'advance' ? 'border-primary bg-primary/5' : 'border-gray-100 hover:border-gray-200'}`}>
                                            ...
                                            <div className="flex-1">
                                                <div className="flex justify-between items-center">
                                                    <p className="text-sm font-bold text-textPrimary uppercase tracking-tight">Advance Exchange</p>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3.5 focus:ring-2 focus:ring-primary/20 outline-none transition-all text-sm font-bold text-textPrimary appearance-none"
                                    >
                    ...
                    <div className="flex justify-end gap-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="bg-secondary text-white px-8 py-3 rounded-xl font-bold hover:bg-opacity-90 transition-all shadow-lg flex items-center gap-2"
                        >
