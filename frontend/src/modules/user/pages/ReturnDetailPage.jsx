        ...
        <div className="bg-background min-h-screen py-4 md:py-12">
            <div className="container mx-auto px-3 md:px-12 max-w-4xl">
                <div className="flex items-center gap-2 md:gap-4 mb-6 md:mb-10">
                    <button onClick={() => navigate('/returns')} className="p-2 -ml-2 hover:bg-gray-100 rounded-lg transition-colors text-textPrimary/70">
                        <ArrowLeft size={20} md:size={24} />
                    </button>
                    <div>
                        <h1 className="text-xl md:text-3xl font-black text-textPrimary uppercase tracking-tighter md:tracking-tight leading-none">
                                            ...
                                            <div key={index} className="flex md:flex-col items-center gap-4 md:gap-3 flex-1 relative min-h-[64px] md:min-h-0">
                                                ...
                                                <div className="min-w-0">
                                                    <p className={`text-[10px] md:text-xs font-black uppercase tracking-widest leading-none md:text-center
                                                        ${isActive ? 'text-textPrimary' : 'text-slate-300'}`}>
                                                        {step.label}
                                                    </p>
                                                    {isCurrent && (
                                ...
                                {returnRequest.items.map((item, i) => (
                                    <div key={i} className="p-4 flex gap-4 items-center">
                                        <div className="relative shrink-0">
                                            ...
                                            <span className="absolute -top-1.5 -right-1.5 min-w-[18px] h-[18px] bg-secondary text-white text-[9px] font-black rounded-lg flex items-center justify-center border-2 border-white shadow-sm">
                                                {item.qty}
                                            </span>
                                        </div>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-6">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="text-sm font-black text-textPrimary leading-snug">{returnRequest.reason}</p>
                                </div>
                            ...
                            {isReplace && replacementVariant && (
                                <div className="p-3 bg-primary/5 rounded-xl border border-primary/10 space-y-3">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="min-w-0">
                                            <p className="text-xs font-black text-textPrimary truncate">{replacementVariant.product.name}</p>
                            ...
                            <div className="pt-5 border-t border-gray-50 flex items-center gap-3 bg-primary/10 p-4 -m-5 mt-5">
