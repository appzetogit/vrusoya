...
const ProfilePage = () => {
                                ...
                                <button key={idx} onClick={item.action} className="w-full flex items-center justify-between p-3.5 hover:bg-slate-50 transition-all border-b last:border-0 border-gray-50 group text-left">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="min-w-0">
                                            <h5 className="font-semibold text-textPrimary text-xs truncate">{item.label}</h5>
                        ...
                        {desktopItems.map((item, idx) => (
                            ...
                            >
                                <div className="flex items-center gap-4 mb-2 w-full">
                                    ...
                                    <h3 className="text-lg font-bold text-textPrimary group-hover:text-green-600 transition-colors">{item.label}</h3>
                                </div>
            ...
            >
                <div className="mb-10 flex items-center gap-5">
                    <button
                        ...
                        className="p-2.5 bg-slate-50 text-textPrimary rounded-xl hover:bg-secondary hover:text-white transition-all group"
                    >
                        <ChevronRight size={16} className="rotate-180 group-hover:-translate-x-1 transition-transform" />
                    </button>
                    <div>
                        <h2 className="text-xl font-bold text-textPrimary tracking-tight uppercase">Available Coupons</h2>
                    ...
                    {couponsLoading ? (
                        ...
                        <div key={coupon.id} className="relative group bg-primary/[0.03] border border-primary/20 rounded-[16px] md:rounded-[24px] p-2.5 md:p-4 hover:border-primary hover:bg-primary/[0.06] transition-all shadow-sm">
                            ...
                            <div className="mb-3 md:mb-4">
                                <h4 className="text-[11px] md:text-sm font-black md:font-bold text-textPrimary mb-0.5 tracking-tighter md:tracking-tight uppercase leading-none">{coupon.code}</h4>
                            ...
                            <button
                                ...
                                className="w-full bg-secondary border-0 py-2 rounded-lg md:rounded-xl font-black md:font-bold text-[8px] md:text-[9px] text-white hover:bg-primary transition-all flex items-center justify-center gap-1.5 md:gap-2 uppercase tracking-tighter md:tracking-widest active:scale-95"
                            >
        ...
        return (
            ...
            >
                <div className="mb-8 md:mb-10 flex items-center gap-3 md:gap-5">
                    <button
                        onClick={() => navigate('/profile')}
                        className="p-2 md:p-2.5 bg-slate-50 text-textPrimary rounded-lg md:rounded-xl hover:bg-secondary hover:text-white transition-all group shrink-0"
                    >
                        <ChevronRight size={14} className="rotate-180 group-hover:-translate-x-1 transition-transform" />
                    </button>
                    <div className="min-w-0">
                        <h2 className="text-lg md:text-xl font-black text-textPrimary tracking-tighter md:tracking-tight uppercase leading-none">Addresses</h2>
                        <p className="text-[8px] md:text-[9px] text-textPrimary/55 font-black uppercase tracking-[0.2em] mt-1 truncate">Manage shipping locations</p>
                    </div>
                </div>

                <div className="flex items-center justify-between gap-4 mb-6 md:mb-8 bg-background p-4 rounded-2xl border border-secondary/20">
                    <div className="min-w-0">
                        <h2 className="text-sm md:text-base font-black text-textPrimary tracking-tight">Your Locations</h2>
                    </div>
                    {!showAddressForm && (
                        <button
                            onClick={handleAddAddress}
                            className="px-5 py-2.5 md:px-6 md:py-3 bg-primary text-white rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 hover:bg-secondary hover:-translate-y-0.5 transition-all shadow-lg shadow-primary/10 active:scale-95 shrink-0"
                        >
                            <Plus size={14} />
                    ...
                    {showAddressForm ? (
                        ...
                        >
                            <div className="mb-8 flex items-center justify-between">
                                <h3 className="text-xl font-black text-textPrimary">{addressToEdit ? 'Edit Address' : 'Add New Address'}</h3>
                                <div className="flex items-center gap-4">
                                    <button
                                        type="button"
                                        onClick={handleDetectLocation}
                                        disabled={detectingLocation}
                                        className="px-3 py-1.5 bg-secondary/10 text-secondary rounded-lg text-[10px] font-black uppercase tracking-wider hover:bg-secondary/20 transition-all flex items-center gap-2 disabled:opacity-50"
                                    >
                                    ...
                                    <button onClick={() => setShowAddressForm(false)} className="text-textPrimary/50 hover:text-secondary font-bold text-sm">Cancel</button>
                                </div>
                            </div>

                            <form onSubmit={handleSaveAddress} className="space-y-6">
                                {/* Address Type Selector */}
                                <div className="flex p-1 bg-background rounded-xl md:rounded-2xl border border-secondary/20 w-fit mb-6">
                                    {['Home', 'Office', 'Other'].map(type => (
                                        <button
                                            key={type}
                                            type="button"
                                            onClick={() => setAddressForm({ ...addressForm, type })}
                                            className={`px-5 md:px-8 py-2 md:py-3 rounded-lg md:rounded-xl font-black text-[10px] md:text-xs uppercase tracking-widest transition-all ${addressForm.type === type ? 'bg-white text-secondary shadow-sm border border-secondary/20' : 'text-textPrimary/55 hover:text-secondary'}`}
                                        >
                                            {type}
                                        </button>
                                    ))}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        <label className="text-[9px] md:text-[10px] font-black text-textPrimary/45 uppercase tracking-widest ml-1">Full Name</label>
                                        <input
                                            required
                                    ...
                                    <div className="space-y-1.5">
                                        <label className="text-[9px] md:text-[10px] font-black text-textPrimary/45 uppercase tracking-widest ml-1">Phone Number</label>
                                        <input
                                            required
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-[9px] md:text-[10px] font-black text-textPrimary/45 uppercase tracking-widest ml-1">Full Address</label>
                                    <textarea
                                        required
                                        value={addressForm.address}
                                        onChange={(e) => setAddressForm({ ...addressForm, address: e.target.value })}
                                        rows="2"
                                        className="w-full bg-background border border-secondary/20 rounded-xl md:rounded-2xl px-5 md:px-6 py-3.5 md:py-4 font-black text-sm text-textPrimary focus:border-secondary outline-none transition-all resize-none placeholder:font-bold placeholder:text-textPrimary/30"
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
                                    <div className="space-y-1.5">
                                        <label className="text-[9px] md:text-[10px] font-black text-textPrimary/45 uppercase tracking-widest ml-1">City</label>
                                        <input
                                            required
                                            value={addressForm.city}
                                            onChange={(e) => setAddressForm({ ...addressForm, city: e.target.value })}
                                            className="w-full bg-background border border-secondary/20 rounded-xl md:rounded-2xl px-5 flex md:px-6 py-3 md:py-3.5 font-black text-xs md:text-sm text-textPrimary focus:border-secondary outline-none transition-all"
                                        />
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-[9px] md:text-[10px] font-black text-textPrimary/45 uppercase tracking-widest ml-1">State</label>
                                        <input
                                            required
                                    ...
                                    <div className="col-span-2 md:col-span-1 space-y-1.5">
                                        <label className="text-[9px] md:text-[10px] font-black text-textPrimary/45 uppercase tracking-widest ml-1">Pincode</label>
                                        <input
                                            required
                                ...
                                <div className="flex items-center gap-3 py-2">
                                    <input
                                        ...
                                        className="w-5 h-5 rounded-lg border-secondary/30 text-secondary focus:ring-secondary shadow-sm"
                                    />
                                    <label htmlFor="isDefault" className="text-[10px] font-black text-textPrimary/55 uppercase tracking-widest cursor-pointer select-none">Set as default address</label>
                                </div>
                        ...
                        >
                            {addresses.length > 0 ? addresses.map(addr => (
                                <div key={addr.id} className={`p-3 md:p-8 rounded-2xl md:rounded-[32px] border ${addr.isDefault ? 'border-secondary/35 bg-secondary/10' : 'border-secondary/15 bg-background'} relative group hover:shadow-xl transition-all`}>
                                    <div className="flex justify-between items-start mb-4 md:mb-8">
                                        <div className={`w-8 h-8 md:w-14 md:h-14 ${addr.isDefault ? 'bg-secondary text-white' : 'bg-white text-secondary'} rounded-lg md:rounded-2xl flex items-center justify-center shadow-sm border border-secondary/20`}>
                                            {addr.type === 'Home' ? <Home size={16} /> : <MapPin size={16} />}
                                        </div>
                                        <div className="flex gap-1 md:gap-2">
                                            <button
                                                onClick={() => handleEditAddress(addr)}
                                                className="w-7 h-7 md:w-10 md:h-10 bg-white text-textPrimary/45 rounded-lg border border-secondary/20 flex items-center justify-center shadow-sm hover:text-secondary transition-colors"
                                            >
                                                <Edit3 size={12} />
                                            </button>
                                            <button
                                                onClick={() => handleDeleteAddress(addr.id)}
                                                className="w-7 h-7 md:w-10 md:h-10 bg-white text-textPrimary/45 rounded-lg border border-secondary/20 flex items-center justify-center shadow-sm hover:text-red-500 transition-colors"
                                            >
                                                <Trash2 size={12} />
                                            </button>
                                        </div>
                                    ...
                                    <div className="space-y-3 md:space-y-5">
                                        <h4 className="text-sm md:text-xl font-bold text-textPrimary tracking-tight flex items-center gap-2">
                                            {addr.type}
                                            {addr.isDefault && (
                                                <span className="text-[7px] md:text-[9px] font-bold uppercase bg-secondary text-white px-1.5 md:px-3 py-0.5 md:py-1 rounded-full">Default</span>
                                            )}
                                        </h4>

                                        <div className="space-y-0.5 md:space-y-1.5 min-h-[40px] md:min-h-0">
                                            <p className="text-[10px] md:text-sm font-bold text-textPrimary/80 truncate">{addr.fullName}</p>
                                            <p className="text-[9px] md:text-[11px] font-medium text-textPrimary/55 leading-tight line-clamp-2">
                                ...
                                <div className="col-span-full py-20 text-center bg-background rounded-none border border-dashed border-secondary/30">
                                    <MapPin size={48} className="mx-auto text-secondary/50 mb-4" />
                                    <p className="text-textPrimary/55 font-bold">No saved addresses found</p>
                                    <button onClick={handleAddAddress} className="mt-4 text-secondary font-black uppercase tracking-widest text-xs">Add your first address</button>
                                </div>
                            )}
                        </motion.div>
                    )}
    ...
    const renderSettings = () => (
        ...
        >
            <div className="mb-10 flex items-center gap-5">
                ...
                <div>
                    <h2 className="text-xl font-bold text-textPrimary tracking-tight uppercase">Account Settings</h2>
            ...
            <div className="max-w-xl">
                <h2 className="text-4xl font-black text-textPrimary mb-4">Profile Settings</h2>
                ...
                <form onSubmit={handleUpdateProfile} className="space-y-8">
                    ...
                    <div className="pt-4 flex items-center gap-6">
                        <button
                            type="submit"
                            className="bg-secondary text-white px-10 py-4 rounded-none font-black uppercase tracking-widest text-xs hover:bg-primary transition-all shadow-lg shadow-secondary/10"
                        >
                            Save Changes
                        </button>
                        {updateSuccess && (
                ...
                <div className="mt-16 pt-12 border-t border-gray-100">
                    <h4 className="text-sm font-black text-textPrimary uppercase tracking-widest mb-6">Security Settings</h4>
                    <button className="w-full flex items-center justify-between p-6 rounded-none border border-gray-100 bg-gray-50/50 group hover:border-primary/30 transition-all">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="font-bold text-textPrimary text-sm">Change Account Password</span>
                        </div>
    ...
    if (profileError || (!userData && !profileLoading && !!user && hasAuthToken)) return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-white p-6">
            ...
            <h2 className="text-xl font-bold text-textPrimary mb-2">Failed to load profile</h2>
        ...
        <div className="bg-[#f8fafc] lg:min-h-screen pb-4 md:pb-20 font-['Inter'] flex flex-col">
            <div className="w-full flex-1">
                <div className="flex flex-col lg:flex-row items-stretch lg:min-h-screen">
                    ...
                    <div className="w-full lg:w-[350px] bg-secondary text-white relative overflow-hidden shrink-0 flex flex-col lg:sticky lg:top-0 h-auto lg:h-screen">
                            ...
                            <div className="flex justify-between items-start mb-6 md:mb-10">
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className="hidden lg:flex absolute -top-1 -right-1 w-7 h-7 bg-white text-textPrimary rounded-full items-center justify-center shadow-lg hover:scale-110 transition-all"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="lg:hidden absolute -top-1 -right-1 w-7 h-7 bg-white text-textPrimary rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-all"
                                    >
