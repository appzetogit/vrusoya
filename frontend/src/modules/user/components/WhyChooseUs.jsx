        ...
        <section className="bg-background py-4 md:py-6 px-4 md:px-12 relative overflow-hidden">
            <div className="container mx-auto">
                <motion.div
                    ...
                    className="bg-gradient-to-r from-primary to-secondary rounded-2xl md:rounded-[40px] px-4 py-8 md:py-12 grid grid-cols-2 md:flex md:flex-row items-start md:items-center justify-between gap-x-4 gap-y-8 md:gap-4 relative overflow-hidden border border-accent/40"
                >
                        ...
                        <React.Fragment key={index}>
                            ...
                            >
                                <div className="relative">
                                    ...
                                    <div className="absolute -top-1 -right-1 w-2.5 h-2.5 bg-accent rounded-full shadow-lg border-2 border-white/40" />
                                </div>
                                <div className="space-y-0.5">
                                    <p className="text-white/90 text-[10px] md:text-sm font-medium uppercase tracking-wider">
                                        {feature.title}
                                    </p>
                            ...
                            {index < features.length - 1 && (
                                <div className="hidden md:block w-px h-16 bg-gradient-to-b from-transparent via-white/35 to-transparent" />
                            )}
