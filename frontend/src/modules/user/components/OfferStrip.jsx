...
const OfferStrip = () => {
    ...
    if (isLoading) return <div className="h-10 bg-accent/10" />;
        ...
        <div className="flex gap-16 md:gap-28 items-center px-4">
            {marqueeItems.map((item, index) => (
                <React.Fragment key={index}>
                    ...
                    <span className="text-secondary/60 font-medium ml-8 md:ml-14">|</span>
                </React.Fragment>
            ))}
        </div>
    );
    ...
    return (
        <div className="bg-[#B9E1C1]/20 backdrop-blur-sm text-[#1F6B87] text-[10px] md:text-xs py-2.5 overflow-hidden font-bold tracking-[0.2em] relative w-full border-b border-[#39B54A]/10">
            {/* Soft Edge Fades */}
