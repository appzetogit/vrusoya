...
const AboutSection = () => {
    ...
    return (
        <section className="bg-background py-4 md:py-6 px-4 md:px-12 relative overflow-hidden">
            <div className="container mx-auto">
                ...
                <div className="md:hidden text-center mb-6 space-y-2">
                        ...
                        <motion.h2
                            initial={{ opacity: 0, y: 10 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            className="text-2xl font-['Poppins'] font-bold text-textPrimary leading-tight"
                        >
                            {displayData.title} <span className="text-secondary">{displayData.highlightedTitle}</span>
                        </motion.h2>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-16">
                        ...
                        <div className="lg:w-1/2 relative h-[280px] md:h-[450px] w-[85%] ml-4 md:w-full md:ml-0 mt-2 md:mt-6 self-start lg:self-center">
                            ...
                            <div className="absolute inset-0 border-2 border-accent rounded-[20px] md:rounded-[32px] -m-4 md:-m-5 z-0" />
                            ...
                            <div className="absolute top-1/2 -translate-y-1/2 -right-10 md:hidden flex flex-col bg-white shadow-[0_8px_30px_rgb(0,0,0,0.12)] rounded-xl overflow-hidden py-2 z-30 min-w-[130px] border border-accent/40">
                                {stats.map((stat, idx) => (
                                    <div key={idx} className="px-5 py-3 border-b border-gray-100 last:border-0 flex flex-col relative group">
                                        <span className="text-lg font-black text-textPrimary leading-none mb-1">
                                            {stat.value}
                                        </span>
                        ...
                        <div className="lg:w-1/2 py-2 md:py-12 flex flex-col justify-center space-y-4 md:space-y-8">
                            <div className="hidden md:block space-y-3 md:space-y-4">
                                <motion.h3
                                    ...
                                    className="text-secondary font-bold tracking-[0.3em] uppercase text-xs md:text-sm"
                                >
                                    {displayData.sectionLabel}
                                </motion.h3>
                                <motion.h2
                                    ...
                                    className="text-2xl md:text-4xl font-['Poppins'] font-bold text-textPrimary leading-tight"
                                >
                                    {displayData.title} <span className="text-secondary">{displayData.highlightedTitle}</span>
                                </motion.h2>
                            </div>
                            ...
                            <div className="space-y-4">
                                <motion.p
                                    ...
                                    className="text-textPrimary/75 text-sm md:text-lg leading-relaxed max-w-xl font-medium"
                                >
                                ...
                                <motion.p
                                    ...
                                    className="text-textPrimary/75 text-sm md:text-lg leading-relaxed max-w-xl"
                                >
                        ...
                        <div className="hidden md:flex pt-8 md:pt-10 border-t border-accent/50 flex-wrap gap-10 md:gap-14">
                            {stats.map((stat, idx) => (
                                <motion.div
                                    key={idx}
                                ...
                                >
                                    <span className="text-3xl md:text-4xl font-black text-textPrimary mb-1 group-hover:text-secondary transition-colors duration-300">
                                        {stat.value}
                                    </span>
                                    <div className="flex items-center gap-2">
                                        <div className="w-5 md:w-8 h-0.5 bg-secondary rounded-full origin-left group-hover:scale-x-125 transition-transform duration-300" />
