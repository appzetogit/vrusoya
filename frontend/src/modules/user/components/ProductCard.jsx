...
const ProductCard = ({ product, showVault = true, compact = false }) => {
    ...
    return (
        <motion.div
            ...
            className="product-card group/product relative bg-white border border-accent/50 rounded-2xl md:rounded-3xl overflow-hidden flex flex-col shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer h-full"
        >
                ...
                <div className={`mt-auto ${compact ? 'space-y-0.5' : 'space-y-0.5 md:space-y-1'}`}>
                    ...
                    <div className={`w-auto overflow-hidden ${compact ? '-mx-2 md:-mx-3' : '-mx-3 md:-mx-4'}`}>
                        <button
                            ...
                            className={`product-card-add-to-cart group/btn w-full py-3 md:py-3.5 rounded-t-none rounded-b-2xl md:rounded-b-3xl text-[8px] md:text-[10px] font-bold uppercase tracking-[0.18em] active:scale-[0.99] flex items-center justify-center border-t translate-y-0 transition-[transform,background-color] duration-300 ease-out shadow-inner ${!selectionRequired && activeStock <= 0
                            ...
                            {!selectionRequired && activeStock <= 0
                                ...
                                : selectionRequired
                                    ...
                                    : isInCart
                                        ? 'Go to Cart'
                                        : (
                                            <div className="product-card-add-to-cart-content relative flex w-full min-h-[1.75rem] items-center justify-center">
                                                <span className="product-card-add-to-cart-label absolute inset-0 flex items-center justify-center transition-all duration-300 ease-out">
                                                    Add to Cart
                                                </span>
                                                <ShoppingCart
                                                    strokeWidth={2.5}
                                                    className="product-card-add-to-cart-icon w-7 h-7 lg:w-8 lg:h-8 transition-all duration-300 ease-out"
                                                />
                                            </div>
                                        )}
                        </button>
